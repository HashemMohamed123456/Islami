...
import 'package:islami/ui/Surah/surah_screen.dart';
import 'package:islami/ui/widgets/quran_title_widet.dart';
import '';
class QuranWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      Expanded(
        flex: 3,
        child: ListView.separated(padding:const EdgeInsets.all(10),itemBuilder: (context,index){
          return QuranTitleWidget(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>SurahScreen(nameOfSurah: suraNames[index],index: index,)),);
            },
